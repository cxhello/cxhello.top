...
title: 'Using Filters in the Spring Boot Framework'
date: '2021-10-29'
icon: 'Java'
draft: false
summary: 'Using Filters in the Spring Boot Framework.'
tags: [Java, Filter]
---
...
我们现在基本都是使用Spring Boot来进行Web开发，使用Servlet的比较少了。我们就在Spring Boot环境下进行演示了。假设现在需要实现一个记录接口运行时间的需求。实现如下：
​
